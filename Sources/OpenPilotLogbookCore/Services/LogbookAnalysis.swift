...
public enum LogbookAnalysis {
    public static func recencySnapshot(flights: [FlightEntry], now: Date = Date()) -> RecencySnapshot {
        ...
        return RecencySnapshot(
            hoursLast12Months: last12Flights.reduce(0) { $0 + $1.totalMinutes },
            hoursLast90Days: last90Flights.reduce(0) { $0 + $1.totalMinutes },
            ...
            instrumentLast90Days: last90Flights.reduce(0) { $0 + $1.instrumentMinutes },
