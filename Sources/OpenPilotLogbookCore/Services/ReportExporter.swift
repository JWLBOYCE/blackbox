    ...
    public static func csv(flights: [FlightEntry]) -> String {
        ...
        let rows = flights.sorted { $0.date < $1.date }.map { flight in
            [
                ...
                LogbookFormatters.hours(flight.flyingMinutes),
                ...
                LogbookFormatters.hours(flight.flyingInstrumentMinutes),
    ...
    public static func html(flights: [FlightEntry], summary: LogbookSummary) -> String {
        ...
        let pages = stride(from: 0, to: sortedFlights.count, by: pageSize).map { start -> String in
            ...
            <tr>
              ...
              <td>\(escape(LogbookFormatters.hours(flight.flyingMinutes)))</td>
              ...
              <td>\(escape(LogbookFormatters.hours(flight.flyingInstrumentMinutes)))</td>
            ...
            let subtotal = LogbookSummary(
                ...
                totalMinutes: pageFlights.reduce(0) { $0 + $1.flyingMinutes },
                ...
                instrumentMinutes: pageFlights.reduce(0) { $0 + $1.flyingInstrumentMinutes },
